...
SRCS = ./library/adding_funds.c ./library/spending_funds.c ./library/reserving.c ./library/loading.c ./library/logging.c ./library/reserving.c ./library/reserving_functions.c app.c
OBJS = $(SRCS:.c=.o)
